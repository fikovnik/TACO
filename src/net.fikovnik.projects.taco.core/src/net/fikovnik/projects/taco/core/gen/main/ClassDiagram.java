...
/**
 * Entry point of the 'PackageDiagram' generation module.
 *
 * @generated
 */
public class ClassDiagram extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/net/fikovnik/projects/taco/core/gen/main/classDiagram";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "genPackage" };
     ...
     * @generated
     */
    public ClassDiagram(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public ClassDiagram(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                ClassDiagram generator = new ClassDiagram(modelURI, folder, arguments);
